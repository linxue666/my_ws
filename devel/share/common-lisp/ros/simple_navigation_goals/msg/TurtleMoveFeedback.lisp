...
(cl:defmethod cl:initialize-instance :after ((m <TurtleMoveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleMoveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_navigation_goals-msg:<TurtleMoveFeedback> is deprecated: use simple_navigation_goals-msg:TurtleMoveFeedback instead.")))

(cl:ensure-generic-function 'present_turtle_x-val :lambda-list '(m))
(cl:defmethod present_turtle_x-val ((m <TurtleMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:present_turtle_x-val is deprecated.  Use simple_navigation_goals-msg:present_turtle_x instead.")
  (present_turtle_x m))

(cl:ensure-generic-function 'present_turtle_y-val :lambda-list '(m))
(cl:defmethod present_turtle_y-val ((m <TurtleMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:present_turtle_y-val is deprecated.  Use simple_navigation_goals-msg:present_turtle_y instead.")
  (present_turtle_y m))
...
(cl:defmethod present_turtle_theta-val ((m <TurtleMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:present_turtle_theta-val is deprecated.  Use simple_navigation_goals-msg:present_turtle_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleMoveFeedback>)))
  ...
  "simple_navigation_goals/TurtleMoveFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleMoveFeedback)))
  "Returns string type for a message object of type 'TurtleMoveFeedback"
  "simple_navigation_goals/TurtleMoveFeedback")
