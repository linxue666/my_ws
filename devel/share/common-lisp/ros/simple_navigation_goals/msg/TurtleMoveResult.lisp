...
(cl:defmethod cl:initialize-instance :after ((m <TurtleMoveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleMoveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_navigation_goals-msg:<TurtleMoveResult> is deprecated: use simple_navigation_goals-msg:TurtleMoveResult instead.")))

(cl:ensure-generic-function 'turtle_final_x-val :lambda-list '(m))
(cl:defmethod turtle_final_x-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_final_x-val is deprecated.  Use simple_navigation_goals-msg:turtle_final_x instead.")
  (turtle_final_x m))

(cl:ensure-generic-function 'turtle_final_y-val :lambda-list '(m))
(cl:defmethod turtle_final_y-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_final_y-val is deprecated.  Use simple_navigation_goals-msg:turtle_final_y instead.")
  (turtle_final_y m))

(cl:ensure-generic-function 'turtle_final_theta-val :lambda-list '(m))
(cl:defmethod turtle_final_theta-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_final_theta-val is deprecated.  Use simple_navigation_goals-msg:turtle_final_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleMoveResult>)))
  ...
  "simple_navigation_goals/TurtleMoveResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleMoveResult)))
  "Returns string type for a message object of type 'TurtleMoveResult"
  "simple_navigation_goals/TurtleMoveResult")
