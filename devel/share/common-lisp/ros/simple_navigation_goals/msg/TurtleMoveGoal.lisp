...
(cl:defmethod cl:initialize-instance :after ((m <TurtleMoveGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleMoveGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_navigation_goals-msg:<TurtleMoveGoal> is deprecated: use simple_navigation_goals-msg:TurtleMoveGoal instead.")))

(cl:ensure-generic-function 'turtle_target_x-val :lambda-list '(m))
(cl:defmethod turtle_target_x-val ((m <TurtleMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_target_x-val is deprecated.  Use simple_navigation_goals-msg:turtle_target_x instead.")
  (turtle_target_x m))

(cl:ensure-generic-function 'turtle_target_y-val :lambda-list '(m))
(cl:defmethod turtle_target_y-val ((m <TurtleMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_target_y-val is deprecated.  Use simple_navigation_goals-msg:turtle_target_y instead.")
  (turtle_target_y m))

(cl:ensure-generic-function 'turtle_target_theta-val :lambda-list '(m))
(cl:defmethod turtle_target_theta-val ((m <TurtleMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_navigation_goals-msg:turtle_target_theta-val is deprecated.  Use simple_navigation_goals-msg:turtle_target_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleMoveGoal>)))
  ...
  "simple_navigation_goals/TurtleMoveGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleMoveGoal)))
  "Returns string type for a message object of type 'TurtleMoveGoal"
  "simple_navigation_goals/TurtleMoveGoal")
